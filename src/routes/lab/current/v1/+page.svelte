	...
	<main>
		...
		{#if activeTab === 'about'}
			<section class="page-section">
				...
				<h1>25 years in the Sierra Nevada</h1>
				<p class="body-copy">
					Current Electric &amp; Alarm has served Plumas County and the surrounding
					areas since 2002. We're licensed, bonded, and insured, providing electrical
					services to residential, commercial, and light-industry customers across
		...
		{#if activeTab === 'services'}
			<section class="page-section">
				...
				<h1>Services</h1>
				<p class="body-copy">
					Full-spectrum electrical, fire alarm, and security work for residential,
					commercial, and light-industry properties.
				</p>
